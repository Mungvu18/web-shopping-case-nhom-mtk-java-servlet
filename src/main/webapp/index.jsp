...
<head>
  ...
  <title>Home | TMK-Shopping Mall</title>
        ...
        <div id="slider-carousel" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <div class="col-sm-6">
                <h1><span>MTK</span>-SHOP</h1>
                <h2>The Best Shoes Ever</h2>
                <p>We only sell the best</p>
                <button type="button" class="btn btn-default get">Get it now</button>
              </div>
              <div class="col-sm-6">
                <img src="https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/viVN/Images/YEEZY_BOOST_350_V2_ASH_STONE_HP_DT_1920x800_tcm337-627594.jpg" class="girl img-responsive" alt="" />
